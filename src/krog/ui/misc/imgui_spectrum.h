...
constexpr ImVec4 ColorConvertU32ToFloat4(ImU32 in) {
  float s = 1.0f / 255.0f;
  return {(float)((in >> IM_COL32_R_SHIFT) & 0xFF) * s, (float)((in >> IM_COL32_G_SHIFT) & 0xFF) * s, (float)((in >> IM_COL32_B_SHIFT) & 0xFF) * s,
...
constexpr struct Light {
  static constexpr std::array<std::pair<const char*, ImVec4>, 193> Values = {{{"GRAY50", ColorConvertU32ToFloat4(IM_COL32(255, 255, 255, 255))},
